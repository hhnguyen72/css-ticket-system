...
## US-001 — day-to-day ticket handling
As a **CSS team operator**, I want incoming customer emails to be automatically parsed and converted into tickets with a priority level, so that I can focus on resolving issues instead of triaging my inbox.

## US-002 — oversight, workload, SLA management
